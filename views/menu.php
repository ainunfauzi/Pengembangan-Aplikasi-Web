...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  ...
  <?php if($this->session->userdata('akses')=='1'):?>
      ...
      <li><a href="<?php echo base_url().'index.php/controller_page/sbmptn'?>">SBMPTN</a></li>
      <li><a href="<?php echo base_url().'index.php/controller_page/universitas'?>">Universitas</a></li>
  ...
  <?php elseif($this->session->userdata('akses')=='2'):?>
      ...
      <li><a href="<?php echo base_url().'index.php/controller_page/sbmptn'?>">SBMPTN</a></li>
      <li><a href="<?php echo base_url().'index.php/controller_page/universitas'?>">Universitas</a></li>
      <li><a href="<?php echo base_url().'index.php/controller_page/latihan_soal'?>">Latihan Soal</a></li>
